...
import studentdemo.AppConstants;
 ...
 */
public class DBUtil {
	private static studentdemo.util.DBUtil db;
	...
	public static studentdemo.util.DBUtil getDBUtil() {
		if (db == null) {
			db = new studentdemo.util.DBUtil();
		}
		return db;
	}
		...
		try {
			if (conn == null || conn.isClosed()) {
				...
				conn = DriverManager.getConnection(AppConstants.JDBC_URL, AppConstants.JDBC_USERNAME,
						studentdemo.AppConstants.JDBC_PASSWORD);
			}
