...
import studentdemo.model.Student;
...
public class StudentDAO extends BaseDAO {
	...
	private static studentdemo.dao.StudentDAO sd = null;

	public static synchronized studentdemo.dao.StudentDAO getInstance() {
		if (sd == null) {
			sd = new studentdemo.dao.StudentDAO();
		}
		return sd;
	}
